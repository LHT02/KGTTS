...
<p align="center">
  <a href="https://qm.qq.com/q/JRnqshDOEM">
    <img src="https://img.shields.io/badge/QQ%20%E5%8F%8D%E9%A6%88%E7%BE%A4-%E7%82%B9%E5%87%BB%E5%8A%A0%E5%85%A5-12B7F5?style=for-the-badge&logo=tencentqq&logoColor=white" alt="点击加入 KIGTTS 反馈群">
  </a>
</p>

<p align="center">
  <sub>点击上方按钮，或使用 QQ 扫描下方二维码加入反馈群。</sub>
</p>
...
长按快捷文本条目可以打开便捷字幕列表弹窗，按分组快速选择其它文本；弹窗支持列表 / 宫格切换、横竖屏状态继承和分组切换动效。竖屏紧凑模式、横屏模式和迷你快捷字幕也会在切换分组时显示分组名提示，减少现场误切。
...
音效板主页面可以在列表和自适应宫格之间切换；在平板或宽屏环境下，分组栏可显示图标和名称。编辑音效包时支持批量管理、批量导入、分组图标弹窗选择和大屏双栏布局，方便在平板或桌面窗口模式下整理大量条目。
...
迷你快捷字幕、迷你快捷名片和迷你音效板会独立记忆分组、滚动位置和列表 / 宫格状态，适合在其它 App 上方持续使用。
